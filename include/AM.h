...
#define AME_OK 0
#define AME_EOF -1
#define AME_NOT_BPLUS -2
#define AME_INVALID_FD -3
#define AME_INVALID_SD -4
#define AME_FILE_ERROR -5
#define AME_INVALID_ATTRL -6
#define AME_INVALID_DEL -7
#define AME_MAX_FILES -8
#define AME_MAX_SCANS -9
#define AME_CREATE_BPLUS -10
#define AME_SEARCH_BPLUS -11
